...
//
///**
// * KeepAliveHttpsTransport deals with the problems with the Android ssl
// * libraries having trouble with certificates and certificate authorities
// * somehow messing up connecting/needing reconnects. Added as generic class for
// * SE since it might be useful in SE environments as well and can be used as an
// * example to create your own transport implementations.
// * 
...
//	public KeepAliveHttpsTransportSE(String host, int port, String file,
//			int timeout) {
...
//	 * {@link org.ksoap2.transport.ServiceConnectionSE} that ignores
//	 * "Connection: close" request property setting and has
//	 * "Connection: keep-alive" always set and is uses a https connection.
//	 * 
//	 * @see org.ksoap2.transport.HttpTransportSE#getServiceConnection()
//	 */
//	// @Override
//	public ServiceConnection getServiceConnection() throws IOException {
//		ServiceConnection serviceConnection = new HttpsServiceConnectionSEIgnoringConnectionClose(

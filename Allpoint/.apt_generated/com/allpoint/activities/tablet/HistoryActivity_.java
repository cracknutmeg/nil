    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.act_history);
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        cardHistoryTitle = ((TextView) hasViews.findViewById(id.tvcardhistoryTitle));
        displayList = ((ExpandableListView) hasViews.findViewById(id.displayList));
        transactionButtonText = ((TextView) hasViews.findViewById(id.iTxtBottomTransaction));
        curSavingIs = ((TextView) hasViews.findViewById(id.curSaving));
        transactionButton = ((ImageButton) hasViews.findViewById(id.iBtnBottomTransaction));
        {
            View view = hasViews.findViewById(id.tvcancelhistory);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        HistoryActivity_.this.onIbtnCancelClicked();
                    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(android.app.Fragment fragment) {
            ...
            intent_ = new Intent(context_, HistoryActivity_.class);
        }

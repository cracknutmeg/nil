    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        email = ((EditText) hasViews.findViewById(id.uname_edit_text));
        skip_button = ((Button) hasViews.findViewById(id.skip_button));
        loginMsgIs = ((TextView) hasViews.findViewById(id.loginMsgIs));
        forget_pass_button = ((Button) hasViews.findViewById(id.forget_pass_button));
        paswd = ((EditText) hasViews.findViewById(id.upass_edit_text));
        signup_button = ((Button) hasViews.findViewById(id.signup_button));
        login_button = ((Button) hasViews.findViewById(id.login_button));
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        LoginActivity_.this.onIbtnLoginClicked();
                    }
        ...
        {
            View view = hasViews.findViewById(id.skip_button);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        LoginActivity_.this.onIbtnSkipClicked();
                    }
        ...
        {
            View view = hasViews.findViewById(id.signup_button);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        LoginActivity_.this.onIbtnSignClicked();
                    }
        ...
        {
            View view = hasViews.findViewById(id.forget_pass_button);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        LoginActivity_.this.onIbtnForgetPasswordClicked();
                    }
